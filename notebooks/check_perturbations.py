...
Called by notebooks/generate_perturbation.py when run with --check; not a standalone CLI.
"""
import os
import sys
import logging
...
def check(args: dict, flat_df=None, mean_df=None, contours=None, fit_df=None, params=None):
    ...
    check_fit.png) whenever fit_df + params are given (from generate_perturbation)."""
    paths = []
